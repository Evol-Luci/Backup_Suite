...
class BackupApp:
    def __init__(self, root):
        ...
        list_scrollbar = ttk.Scrollbar(job_listbox, orient=tk.VERTICAL, command=job_listbox.yview)
        ...
        log_scrollbar = ttk.Scrollbar(log_text_widget, orient=tk.VERTICAL, command=log_text_widget.yview)
